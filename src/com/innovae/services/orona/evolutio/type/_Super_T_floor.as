 ...
 * of this value object you may modify the generated sub-class of this class - T_floor.as.
 */
...
[ExcludeClass]
public class _Super_T_floor extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _T_floorEntityMetadata;
    ...
    model_internal var _internal_areas_leaf:com.innovae.services.orona.evolutio.type.T_area;
    private var _internal_id : int;
    private var _internal_name : String;
    private var _internal_position : int;
    private var _internal_show_position : String;
    private var _internal_description : String;
    private var _internal_aditional_info : String;
    ...
    public function _Super_T_floor()
    {
        _model = new _T_floorEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get show_position() : String
    {
    ...
    [Bindable(event="propertyChange")]
    public function get aditional_info() : String
    {
        return _internal_aditional_info;
    }
    ...
    public function set show_position(value:String) : void
    {
        var oldValue:String = _internal_show_position;
        if (oldValue !== value)
        {
            _internal_show_position = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "show_position", oldValue, _internal_show_position));
        }
    }
    ...
    public function set aditional_info(value:String) : void
    {
        var oldValue:String = _internal_aditional_info;
        if (oldValue !== value)
        {
            _internal_aditional_info = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "aditional_info", oldValue, _internal_aditional_info));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _T_floorEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _T_floorEntityMetadata) : void
    {
        var oldValue : _T_floorEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
