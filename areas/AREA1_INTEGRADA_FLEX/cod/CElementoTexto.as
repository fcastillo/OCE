package cod 
{
	...
	public class CElementoTexto extends CElementoBase
	{
		...
		{	
			...
			trace("[CElementoTexto] - load() -> tamaño="+getTamaño());
			if (getTamaño().toString() != "NaN") myFormat.size = getTamaño();
			else myFormat.size = 30;
			...
			trace("Creando texto con transparencia "+this.getTransparencia());
			myTextField.alpha = this.getTransparencia();
