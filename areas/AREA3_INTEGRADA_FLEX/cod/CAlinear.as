package cod
{
	...
	{		
		...
		override public function load():int
		{
			...
			btnDistVertical.buttonMode = true;
			btnDistHorizontal.buttonMode = true;
			...
			btnDistVertical.addEventListener(MouseEvent.MOUSE_DOWN,onBotonDistribuirVertical);
			btnDistHorizontal.addEventListener(MouseEvent.MOUSE_DOWN,onBotonDistribuirHorizontal);
			
			btnDistVertical.addEventListener(MouseEvent.MOUSE_UP,onBotonUp);
			btnDistHorizontal.addEventListener(MouseEvent.MOUSE_UP,onBotonUp);
			
			mcBoton.addEventListener(MouseEvent.CLICK,onBotonEscenario);
		...
		public function init()
		{
			...
			btnDistVertical.gotoAndStop(1);
			btnDistHorizontal.gotoAndStop(1);
			
			mcBoton.selected = false;
			enEscenario = false;
		}
		...
		{
			if (mcBoton.selected) enEscenario = true;
			else enEscenario = false;
		}
