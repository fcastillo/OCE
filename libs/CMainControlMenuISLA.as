package  {
	...
	public class CMainControlMenuISLA extends MovieClip 
	{
		...
		public function CMainControlMenuISLA() 
		{
			// constructor code
		...
		//---------Función crearEstilos---------//
		//-- Crea las plantillas pre-definidas
		//--------------------------------------//
		...
		public function cargarImagenFondo(url_fondo:String)
		{
			...
			loader.load(new URLRequest(pathDatos.concat("\\",url_fondo)));			
		}
		...
		public function cambiar_estilo(nombre:String)
		{
			...
			if (estilo != null)
			{
				//Si hay un color de fondo lo borramos
				eliminar_color_fondo();
				...
				if ((estilo.getNombreEstilo() == "Estilo1") || (estilo.getNombreEstilo() == "Estilo2"))
				{
					txtCabecera.y = 30;
					txtCabecera.x = 150;
					txtCabecera.width = 300;
					txtTitulo.y = 130;
					txtTitulo.x = 60;
					txtTitulo.width = 480;
					txtSubtitulo1.y = 208;
					txtSubtitulo1.x = 60;
					txtSubtitulo1.width = 480;
					txtSubtitulo2.y = 369;
					txtSubtitulo2.x = 60;
					txtSubtitulo2.width = 480;
					txtSubtitulo3.y = 544;
					txtSubtitulo3.x = 60;
					txtSubtitulo3.width = 480;
					txt1.y = 243;
					txt1.x = 60;
					txt1.width = 480;
					txt2.y = 406;
				...
				else if ((estilo.getNombreEstilo() == "Estilo3") || (estilo.getNombreEstilo() == "Estilo4"))
				{
					txtCabecera.y = 30;
					txtCabecera.x =40;
					txtCabecera.width = 520;
					txtTitulo.y = 130;
					txtTitulo.x = 40;
					txtTitulo.width = 520;
					txtSubtitulo1.y = 218;
					txtSubtitulo1.x = 40;
					txtSubtitulo1.width = 520;
					txtSubtitulo2.y = 379;
					txtSubtitulo2.x = 40;
					txtSubtitulo2.width = 520;
					txtSubtitulo3.y = 554;
					txtSubtitulo3.x = 40;
					txtSubtitulo3.width = 520;
					txt1.y = 253;
					txt1.x = 40;
					txt1.width = 520;
					txt2.y = 416;
